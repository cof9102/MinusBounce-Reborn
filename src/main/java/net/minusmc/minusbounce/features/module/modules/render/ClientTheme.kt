...
@ModuleInfo(name = "ClientTheme", description = "ClientTheme Skid Skid", category = ModuleCategory.RENDER)
object ClientTheme : Module() {
    val mode = arrayOf(
        "Cherry",
        "Water",
        "Magic",
    ...
    val ClientColorMode = ListValue("ColorMode", mode, "Cherry")
    val textValue = BoolValue("TextStaticColor", false)
    val fadespeed = IntegerValue("Fade-speed", 1, 1, 10)
    val updown = BoolValue("Fade-Type", false)
